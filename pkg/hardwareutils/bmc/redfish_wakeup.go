...
func (a *redfishWakeupAccessDetails) DriverInfo(bmcCreds Credentials, preProvExtraKernParams string) map[string]interface{} {
	driverInfo := a.redfishAccessDetails.DriverInfo(bmcCreds, preProvExtraKernParams)
