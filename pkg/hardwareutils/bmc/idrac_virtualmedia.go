...
func (a *redfishiDracVirtualMediaAccessDetails) DriverInfo(bmcCreds Credentials, preProvKernParams string) map[string]interface{} {
	return a.redfishAccessDetails.DriverInfo(bmcCreds, preProvKernParams)
}
