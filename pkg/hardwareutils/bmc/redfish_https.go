...
func (a *redfishHTTPBootMediaAccessDetails) DriverInfo(bmcCreds Credentialsi, preProvKernParams string) map[string]interface{} {
	result := map[string]interface{}{
		...
		"kernel_append_params": preProvKernParams,
	}
