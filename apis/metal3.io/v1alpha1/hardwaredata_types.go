...
type Accelerator struct {
	// The PCI vendor ID of the device, e.g. "10de".
	VendorID string `json:"vendorID,omitempty"`

	// The PCI device ID of the device, e.g. "1eb8".
	DeviceID string `json:"deviceID,omitempty"`

	// The type of the accelerator device, e.g. "GPU".
	Type string `json:"type,omitempty"`

	// A human readable description of the device, e.g.
...
type HardwareDetails struct {
	...
	// List of accelerator devices (e.g. GPUs) discovered on the host.
	// This requires the "pci-devices" inspection collector and the
	// "accelerators" inspection hook to be enabled in Ironic.
