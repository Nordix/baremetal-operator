...
require (
	...
	github.com/metal3-io/baremetal-operator/test v0.5.1
...
require (
	...
	github.com/metal3-io/cluster-api-provider-metal3/test v1.5.1 // indirect
	...
	sigs.k8s.io/cluster-api/test v1.5.6 // indirect
